...
/** `start_url` PWA — pierwszy ekran po uruchomieniu z ikony, więc to tędy biegnie zimny start. */
@Component({
  standalone: true,
  template: `<div class="p-6 text-center text-surface-400 text-sm">Ładowanie…</div>`,
})
